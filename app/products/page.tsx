    ...
    <main className="min-h-screen bg-zinc-950 text-white">
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="flex flex-wrap items-center gap-4 mb-6 bg-zinc-900 rounded-2xl border border-zinc-800 p-4">
          ...
          {/* Sort Filter */}
          <div className="flex items-center gap-3">
            <label className="text-sm font-semibold text-zinc-400">Sort:</label>
            <select
              value={sortBy}
          ...
          {(selectedCategory !== "all" || searchQuery) && (
            <button
              onClick={() => {
                ...
                // Search query clear karne ke liye URL update
        ...
        {loading ? (
          ...
          <div className="text-center py-20">
            <p className="text-2xl text-zinc-500">No products found</p>
            <p className="text-zinc-600 mt-2">Try adjusting your filters or search.</p>
          </div>
        ) : (
